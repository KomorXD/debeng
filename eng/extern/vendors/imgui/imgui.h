...
namespace ImGui
{
    ...
    void PrettyDragFloat(const char *label, float *v, float speed = 1.0f,
                         ...
                         float label_width = 64.0f);
    void PrettyDragFloat2(const char *label, float *v, float speed = 1.0f,
                          float min = 0.0f, float max = 0.0f,
                          const char *format = "%.3f",
                          float label_width = 64.0f);
    void PrettyDragFloat3(const char *label, float v[3], float speed = 1.0f,
                          float min = 0.0f, float max = 0.0f,
                          const char *format = "%.3f",
                          float label_width = 64.0f);
    void PrettyDragFloat4(const char *label, float v[4], float speed = 1.0f,
                          ...
                          const char *format = "%.3f",
                          float label_width = 64.0f);
    void PrettyColorEdit3(const char *label, float col[3], float label_width);
