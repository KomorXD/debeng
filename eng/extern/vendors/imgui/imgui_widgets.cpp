...
void ImGui::PrettyDragFloat2(const char *label, float *v, float speed,
...
void ImGui::PrettyDragFloat3(const char *label, float v[3], float speed,
                             float min, float max, const char *format,
                             float label_width) {
    ImGui::PushID(label);
...
void ImGui::PrettyColorEdit3(const char *label, float col[3],
                             float label_width) {
    ImGui::PushID(label);
...
void ImGui::BeginPrettyCombo(const char *label, const char *preview,
